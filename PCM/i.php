...
$r = $s[10]&3;
$cfg = file('log.cfg');
$ss = substr($cfg[0],0,2).".".substr($cfg[0],2,1);
for ($i = 0; $i < 8; $i++) {
  $c[$i] = 'rgb('.ceil($s[$i+2] * 2.56).',32,255)';
  $s[$i] = substr_replace($s[$i+2],'',-1,1);
}
?>
...
<a href="log.txt?s=<?echo date('s');?>"style="position:absolute;left:180px;top:90px;color:maroon;">View log</a>
<a href="clog.php"style="position:absolute;left:180px;top:120px;color:maroon;">Clean log</a>
<a href="files.php"style="position:absolute;left:180px;top:150px;color:maroon;">Download files</a>
<div style="position:absolute;left:2px;top:330px;width:180px;height:24px;line-height:24px;font-size:20px;text-align:center;"><?echo "Setpoint: ".$ss."&#8451;"?></div>
<div style="position:absolute;left:2px;top:350px;width:180px;height:40px;line-height:40px;font-size:24px;text-align:center;"><?echo "Home: ".$s[6]."&#8451";?></div>
<div style="position:absolute;background:#CEE;left:182px;top:350px;width:308px;height:40px;line-height:40px;font-size:24px;text-align:center;"><?echo "Vegetable store: ".$s[7]."&#8451";?></div>
...
<div class="border" style="left:437px;top:296px;width:6px;height:12px;background:#963;"></div>
