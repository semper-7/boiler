...
for ($i = 0; $i < 8; $i++) {
  if (s[$i+2] < 64) {
  $c[$i] = 'rgb('.($s[$i+2] << 2).',32,255)';
  } else {
  $c[$i] = 'rgb(255,32,'.(255 - (($s[$i+2] - 64) << 2 )).')';
  }
...
<a href="log.txt?s=<?echo date('dHis')?>"style="position:absolute;left:180px;top:90px;color:maroon;">View log</a>
<a href="log.cfg?s=<?echo date('dHis')?>"style="position:absolute;left:180px;top:120px;color:maroon;">View configurations</a>
...
<div style="position:absolute;background:#CEE;left:182px;top:350px;width:308px;height:40px;line-height:40px;font-size:24px;text-align:center;">Vegetable store: <?echo $s[7]?>&#8451</div>
