...
lll0:	invoke	ReadFile,hCOM,ADDR buf,1,ADDR SZRW,0
	...
	jz	lll0
	push	SZRW
	invoke	WriteFile,hStdOut,ADDR buf,SZRW,ADDR SZRW,0
	pop	eax
...
llt0:	invoke	ReadFile,hStdIn,ADDR buf2,1,ADDR SZRW2,0
	invoke	WriteFile,hCOM,ADDR buf2,SZRW2,ADDR SZRW2,0
	jmp	llt0
TProc	ENDP
