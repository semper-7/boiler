...
$cfg = file('log.cfg');
 for ($i = 1; $i < 10; $i++) {
  ...
  $c[$i] = 'rgb(255,32,'.(255 - (($s[$i] - 64) << 2 )).')';
  }
 $s[$i] = substr_replace($s[$i],'',-1,1);
 }
...
<div class="TALayer" style="top:42px;background:<?echo $c[1]?>;"><?echo $s[1]?>&#8451</div>
<div class="TALayer" style="top:78px;background:<?echo $c[2]?>;"><?echo $s[2]?>&#8451</div>
<div class="TALayer" style="top:114px;background:<?echo $c[3]?>;"><?echo $s[3]?>&#8451</div>
<div class="TALayer" style="top:150px;background:<?echo $c[4]?>;"><?echo $s[4]?>&#8451</div>
<div class="TALayer" style="top:186px;background:<?echo $c[5]?>;"><?echo $s[5]?>&#8451</div>
